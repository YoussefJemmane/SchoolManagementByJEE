...
<t:layout pageTitle="Editer Un Cours">
    ...
    <div class="container mx-auto">
        <div class="flex justify-center px-6 my-12">
            ...
            <div class="w-full lg:w-1/2 bg-white p-5 rounded-lg lg:rounded-l-none">
                <h3 class="pt-4 text-2xl text-center">Editer un cours</h3>
                <form class="px-8 pt-6 pb-8 mb-4 bg-white rounded" method="post" action="/CoursUpdate?id=<c:out value="${cours.id}"/>">
